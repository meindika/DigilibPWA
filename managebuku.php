    ...
    <div class="page">
              ...
              <table class="table table-stripped tabble-sm">
                ...
                <tbody>
                  <?php foreach ( $kueri as $data ) : ?>
                    ...
                    <td><?= $jenis; ?></td>
                    <td>
                      <a href="img/cover/<?= $cover; ?>">
                      <img src="img/cover/<?= $cover; ?>" class="img-thumbnail img-responsive" alt="img" style="width:50px;">
                      </a>
                    </td>
              ...
              <div class="modal-body">
                <form method="post" action="" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                            ...
                            <input placeholder="Cover"  type="file" id="cover" name="cover" class="form-control" required>
                        </div>
      ...
      <footer class="main-footer">
        <div class="container-fluid">
          <div class="row">
            <div class="col-sm-6">
            <p>&copy;Copyright SI Perpustakaan</a>  <span id="year-cred"></span></p></div>
