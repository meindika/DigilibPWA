	...
	<header class="header-area header-area2">
        <div class="container">
            <div class="row">
                <div class="col-lg-2">
                    <div class="logo-area">
                        <a href="index.html"><img src="assets/images/logo/alogo.png" alt="logo"></a>
                    </div>
                </div>
                <div class="col-lg-10">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <p class="pt-2"><i>Hubungi kami untuk mendapatkan informasi dan pemesanan.</i></p>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="single-widget single-widget1">
                            <a href="index.html"><img src="assets/images/logo/alogo.png" alt=""></a>
                            </div>
                    </div>
                    <div class="col-md-4">
                        <div class="single-widget single-widget2 my-5 my-md-0">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="info-text">
                                    <p>Jl. Turgo No 3, Beran, Tridadi, Sleman, DI Yogyakarta 55511</p>
                                </div>
                            </div>
                            <div class="d-flex">
                                <div class="into-icon">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="info-text">
                                    <p>perpusarsip@slemankab.go.id</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="single-widget single-widget3">
                            <h5 class="mb-4">Jam Layanan</h5>
                            <p>Sabtu-Minggu ...................... 8.00 - 12.00</p>
                            <p>Senin-Kamis ..................... 8.00 - 15.15</p>
                            <p>Jum'at ......................... 8.00 - 14.15 </p>
                        </div>
                    </div>
                </div>
            </div>
